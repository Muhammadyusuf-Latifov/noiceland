  ...
  if (forms.length > 0) {
    ...
    forms.forEach((form) => {
        ...
        inputs.forEach((input) => {
          input.addEventListener("blur", function (e) {
            ...
            if (!elementTarget.classList.contains("_invalid")) {
              ...
              if (
                !elementTarget.classList.contains("_email") &&
                !elementTarget.classList.contains("_password") &&
                !elementTarget.classList.contains("_phone")
              ) {
              ...
              if (elementTarget.classList.contains("_password")) {
                ...
                if (
                  minimum8Chars.test(input.value) &&
            ...
            if (!elementTarget.classList.contains("_invalid")) {
              ...
              if (textarea.value.length < 2) {
                ...
                if (textarea.classList.contains("_invalid")) {
                  if (
                    textarea.parentElement.querySelectorAll(".field__error")
                      .length < 1
                  ) {
                    const template = `
          ...
          if (isMobile.any()) {
            ...
            if (iconErrors.length > 0) {
              iconErrors.forEach((iconError) => {
                if (
                  !iconError.nextElementSibling.classList.contains("_active")
                ) {
      ...
      function formBlur(textInfo, e) {
        ...
        if (elementTarget.classList.contains("_invalid")) {
          if (
            elementTarget.parentElement.querySelectorAll(".field__error")
              .length < 1
          ) {
            const template = `
							<div class="field__error field-error">
            ...
            elementTarget.parentElement.insertAdjacentHTML(
              "beforeEnd",
              template
            );
          }
      ...
      function validCheckbox(checkbox) {
        if (checkbox.classList.contains("_required")) {
          ...
          if (checkbox.checked === true) {
            ...
            if (
              checkbox.parentElement.querySelectorAll(".field__error").length <
              1
            ) {
              const template = `
										<div class="field__error field-error">
        ...
        inputs.forEach((input) => {
          if (input.classList.contains("_required")) {
            ...
            if (
              ...
              !input.classList.contains("_password") &&
              !input.classList.contains("_phone") &&
              !input.classList.contains("_name")
            ) {
              let textInfo = `${textError}`;
              addError(textInfo);
            }
            ...
            function addError(textInfo) {
              if (input.classList.contains("_invalid")) {
                if (
                  input.parentElement.querySelectorAll(".field__error").length <
                  1
                ) {
                  const template = `
										<div class="field__error field-error">
...
const topE1 = document.querySelector(".top");

window.addEventListener("scroll", () => {
  if (document.documentElement.scrollTop > 200) {
    topE1.style.bottom = "30px";
  } else {
    topE1.style.bottom = "-60px";
  }
});
